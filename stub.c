...
uint64_t asm_dot_mbt_mmap(size_t length) {
    void* pointer = mmap(NULL, length, PROT_READ | PROT_WRITE | PROT_EXEC, MAP_ANON | MAP_PRIVATE, -1, 0);
...
int64_t asm_dot_mbt_exec(uint64_t start, const void* machcode, size_t length) {
